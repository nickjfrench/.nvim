...
-- Ctrl S to save in normal or insert modes.
vim.keymap.set({ 'n', 'i' }, '<C-s>', '<Esc>:w<CR>', { desc = 'Save File', silent = true, noremap = true })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        python = { 'ruff' },
        go = { 'gofmt' },
        vue = { 'eslint', 'eslint_d', 'prettier', stop_after_first = true },
